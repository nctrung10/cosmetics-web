    ...
    <div class="row">
        <div class="col-12">
            <div class="content text-center my-5">
                <div class="alert alert-warning d-flex align-items-center justify-content-center m-0 py-5" role="alert">
                    ...
                    <h3 class="m-0">Trang bạn đang cố truy cập không tồn tại.</h3> 
                </div>
            </div>
        </div>
    </div>
